...
<section class="flex-column loading">
    ...
    <main class="flex-column main">
        ...
        <input class="hover post-input" type="text" name="post_content" placeholder="What's on your mind, Marc?" required>
...
if (isset($_POST["submit_post"])) {
    ...
    $sqlInsert = "INSERT INTO post_info (user_id, date, time, text) VALUES ('$userId', '$date', '$time', '$postContent')";
